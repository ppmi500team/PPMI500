...
```{r,echo=FALSE}
permdf$logp = log( permdf$anv )
gghistogram( permdf, x = 'logp',
      add = "mean", add_density = TRUE, title='SiMLR original data projection vs permuted projections: model significance', fill='permstate', legend='none')
```